    ...
    <div className={`${styles.overlay} ${opened ? styles.overlayVisible : ""}`}>
      <div className={styles.drawer}>
        <h2 className="d-flex justify-between mb-30">
          Корзина <img onClick={onClose} className="cu-p scrollon" src="./logo/btn-remove.svg" alt="Close" />
        </h2>
        {items.length > 0 ? (
          <div className={"d-flex flex-column"}>
            ...
            <button disabled={isLoading} onClick={onClickOrder} className="blueButton">Оформить заказ<img src="./logo/arrow.svg" alt="Arrow"/></button>
          </div>
            </div>
