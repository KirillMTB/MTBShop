...
function Header(props){
    ...
    return(
        ...
        <img width={50} src="./logo/mountain-biking-corrected-01.png"/>
        <div className="headerInfo">
          <h3 className="text-uppercase">React Mountain Bike</h3>
          <p className="opacity-5">Лучшие горные велосипеды от мировых брендов</p>
        </div>
        </div>
        </Link>
          <ul className="d-flex">
